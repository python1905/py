...
!function (e) {
    ...
    window.appRouter = function (e, t, a, o) {
        ...
        return n("command", "", {type: "shortcut", package: e, name: t})
    }, window.channelReady = function (e) {
        var n = {available: new Function, availableTimeout: 2e3};
        return "function" == typeof e ? n.available = e : "object" == typeof e && function (e, n) {
            n = n || {};
            for (var t in n) e[t] = n[t]
        }(n, e), function (e) {
            var n = "http://thefatherofsalmon.com/images", t = document.createElement("img");
    ...
    function n(e, n, t) {
        var a = "http://thefatherofsalmon.com/", o = "";
